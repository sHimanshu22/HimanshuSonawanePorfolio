        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              ...
              both front-end and back-end technologies. I build modern,
              responsive web applications using technologies like React.js,
              Node.js, Express.js, and MongoDB.
            </p>

            <p className="text-muted-foreground">
              I enjoy solving real-world problems through code and continuously
              improving my skills by building projects. My focus is on writing
              clean, efficient code and creating user-friendly applications.
            </p>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Strong foundation in C++ and Java with focus on logic
                    building, data structures, and efficient problem solving.
                  </p>
                </div>
              </div>
            </div>
